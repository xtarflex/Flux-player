    ...
    <div class="island-layer" transition:fade={{ duration: 300 }}>
      <div class="letter-box">
        ...
        {:else if currentLetter === 2}
          <svg viewBox="0 0 1024 1024" class="brand-svg">
            <path fill="var(--tertiary)" d="M356.6 514.01c0.25 45.32 9.16 88.58 25.16 128.22 39.77 98.54 123.35 174.71 226.59 204.37-30.6 8.8-62.92 13.51-96.35 13.51-55.85 0-108.64-13.15-155.41-36.53C242.33 766.49 163.88 648.41 163.88 512V260.24c0-22.4 7.75-43.08 20.71-59.49v-0.01c17.68-22.4 45.06-36.85 75.64-36.85 26.49 0 50.59 10.84 68.06 28.31a97.143 97.143 0 0 1 13.12 16.29c9.6 14.97 15.18 32.75 15.18 51.76V512c0 0.67 0 1.34 0.01 2.01z"/>
            ...
            <path fill="var(--secondary)" d="M831.82 192.19c2.69 2.69 5.21 5.53 7.57 8.52 12.97 16.41 20.73 37.11 20.73 59.53v59.06c0 33.43-4.71 65.76-13.51 96.35-27.09 94.27-92.94 172.13-179.19 215.24-46.21 23.09-98.28 36.2-153.4 36.52 84.9-1.08 153.4-70.23 153.4-155.4V260.24c0-19.01 5.58-36.78 15.19-51.75 13.65-21.31 35.47-36.96 60.95-42.46 6.53-1.4 13.29-2.15 20.22-2.15 22.42 0 43.1 7.76 59.53 20.73 2.97 2.36 5.81 4.88 8.51 7.58z"/>
          </svg>
        {:else}
          <svg viewBox="0 0 1024 1024" class="brand-svg">
