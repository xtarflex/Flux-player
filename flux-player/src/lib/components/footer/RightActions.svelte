...
<div class="right-section">
  ...
  {#if showPiP}
    <button 
      ...
      onclick={togglePiP}
      use:tooltip={{ content: isPiPActive ? 'Exit Picture-in-Picture' : 'Picture-in-Picture', placement: 'top' }}
    >
      <svg viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
  ...
  <button 
    ...
    use:tooltip={{ content: isFullscreen ? 'Exit Fullscreen' : 'Fullscreen', placement: 'top' }}
  >
    {#if isFullscreen}
      <!-- Exit Fullscreen -->
      <svg viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
