<script lang="ts">
  ...
  import { mediaItems, selectedMediaId, loadLibraryFromDb, libraryLoadState, toggleFavorite, toggleWatched, batchToggleFavorite } from '$lib/stores/media';
      ...
      {#if isSelectionMode}
        <div class="batch-action-bar glass">
          ...
          <div class="batch-actions">
            ...
            <button class="action-btn" onclick={() => batchToggleFavorite(selectedBatchIds)} use:tooltip={{ content: 'Toggle Favorites', placement: 'bottom' }}>
