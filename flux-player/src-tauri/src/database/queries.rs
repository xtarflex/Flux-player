...
pub fn clean_stale_media<R: Runtime>(app: &AppHandle<R>, dir_path: &str) -> AppResult<usize> {
    ...
    if !stale_paths.is_empty() {
        ...
        {
            // Bolt: Optimize bulk database operations by preparing the statement outside the loop
...
pub fn save_media_items<R: Runtime>(
    ...
    {
        // Bolt: Optimize bulk insert/update by compiling the SQL once before the loop
