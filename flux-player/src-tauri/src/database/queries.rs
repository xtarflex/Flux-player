...
pub fn clean_stale_media<R: Runtime>(app: &AppHandle<R>, dir_path: &str) -> AppResult<usize> {
    ...
    if !stale_paths.is_empty() {
        ...
        // ⚡ Bolt: Move statement preparation outside the loop to avoid redundant parsing overhead
...
pub fn save_media_items<R: Runtime>(
    ...
    // ⚡ Bolt: Move statement preparation outside the loop to significantly speed up bulk inserts
